...
//            spinner = (ProgressBar)findViewById(R.id.progressBar);
            ...
            if (!(emailid2.isEmpty() || username2.isEmpty() || confirmpassword2.isEmpty() || password2.isEmpty() || firstname2.isEmpty() || lastname2.isEmpty() ||phonenumber2.isEmpty()))
            {
                if (length == 10) {
        ...
        {
            Toast.makeText(RegisterActivity.this, "None of the fields should be empty", Toast.LENGTH_SHORT).show();
